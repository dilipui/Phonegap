...
/**
 * This is the start of the example.js from https://github.com/okamototk/jqm-mobile-bookmark-bubble
 */
...
google.bookmarkbubble.Bubble.prototype.TIME_UNTIL_AUTO_DESTRUCT = 4000;

/** page to bookmark bubble (generally, this should be top page) */
if(typeof(page_popup_bubble)=='undefined'){
  popup_bubble_page_class = '.events.index';
}
...
$(document).bind('mobileinit', function(){
 ...
 $( document ).on('pageinit', popup_bubble_page_class, function() {
  window.setTimeout(function() {
    var bubble = new google.bookmarkbubble.Bubble();

    var parameter = '#bookmarked';

    var bubbleStorageKey = 'GAME_ON_BUBBLE_STORAGE_KEY';

    bubble.hasHashParameter = function() {
      return (localStorage.getItem(bubbleStorageKey) !== null);
    };

    bubble.setHashParameter = function() {
      if (!this.hasHashParameter()) {
        location.href = parameter;
        localStorage.setItem(bubbleStorageKey, parameter);
      }
    };
